...
import uuiddashboard')
@jwt_required()
from datetime import timedelta

app = Flask(__name__)
app.config['SECRET_KEY'] = 'your_secret_key_here'You said:
salam
￼
ChatGPT said:
Salam! Necəsiz? Sizə necə kömək edə bilərəm?

￼
You said:
from flask import Flask, render_template, request, 
app.config["JWT_SECRET_KEY"] = app.config['SECRET_KEY']  # Flask-JWT-Extended secret
app.config["JWT_TOKEN_LOCATION"] = ["headers"]  # Accept JWTs from headers only
